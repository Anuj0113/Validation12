<?php 
  ...
  $conn = new mysqli('localhost','root','','wordpress');
     ...
     $stmt=("UPDATE maccount SET cname='$_POST[cname]',email = '$_POST[email]',number='$_POST[number]',address = '$_POST[address]',state = '$_POST[state]',zip='$_POST[zip]',country='$_POST[country]',language='$_POST[language]',currency = '$_POST[currency]',city = '$_POST[city]' where number='$_POST[number]'");
