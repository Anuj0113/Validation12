...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>All Address Deleted Successfully</h1>"; ?>
            <a href="AddressNew1.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
...
<?php
	...
	$stmt =("DELETE FROM address WHERE home LIKE '%$home%' && email='$email1'");
      mysqli_query($conn,$stmt);?>
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            <img src="image/right1.jpg" class="righticon">
            <?php echo"<h1>Address Deleted Successfully</h1>"; 

    echo "<a href='AddressShowing1.php'><button class='signup-btn' type='submit' value='Ok'>Ok</button></a>";
