				...
				<div class='row'>
					<div class='col-md-4 col-xs-6'>
                        ...
                        <div class='products-widget-slick' data-nav='#slick-nav-3'>
							<div>
 <?php
                                        $stmt =("select * from product where id=2");
        ...
        $row3 = mysqli_fetch_array($re);
			...
			<h4 class='product-price'>₹".$row3['price']."<del class='product-old-price'>₹100</del></h4>
							...
							<div>
									 ...
									 <?php
                                        $stmt =("select * from product1 where id=7");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
		...
		";}; ?>
				...
				<?php
                                        $stmt =("select * from product1 where id=8");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
								<div class='product-widget'>
								<a href='product8.php?a1=8.1'>
									<div class='product-img'>
										<img src='".$row3['image']."' alt=''>
									</div>
									<div class='product-body'>
			...
			<h4 class='product-price'>₹".$row3['price']."<del class='product-old-price'>₹35 </del></h4>
								...
								";}; ?>
									...
									<?php
                                        $stmt =("select * from product1 where id=9");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
								<div class='product-widget'>
								<a href='product9.php?a1=9.1'>
									<div class='product-img'>
										<img src='".$row3['image']."' alt=''>
									</div>
									<div class='product-body'>
					...
					<div class='col-md-4 col-xs-6'>
						...
						<div class='products-widget-slick' data-nav='#slick-nav-5'>
							<div>
											...
											<?php
                                        $stmt =("select * from product1 where id=10");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
								<div class='product-widget'>
								<a href='product10.php?a1=10.1'>
									<div class='product-img'>
										<img src='".$row3['image']."' alt=''>
									</div>
									<div class='product-body'>
