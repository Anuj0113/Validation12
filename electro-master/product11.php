					...
					<div class='col-md-5'>
						<div class='product-details'>
							...
							<div class='add-to-cart'>
								...
								<button class='add-to-cart-btn' name='b25'><i class='fa fa-shopping-cart'></i>add to cart</button>
							</form><br>
										<form action='wishlist.php' method='post'>
								<button class='add-to-cart-btn' name='a25'><i class='fa fa-shopping-cart'></i>Add to wishlist</button>
							</form>
							</div>
