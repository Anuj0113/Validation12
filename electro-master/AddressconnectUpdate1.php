...
<html lang="en">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body>
        ...
        <header>
            ...
            <div id="top-header">
                <div class="container">
            <ul class='header-links pull-left' style='margin-left: 10px;'><li><a href='AddressUpdate1.php' style='color:white; margin-left: -150px;'>&larr;Back</a></li>
  ...
  <?php 
    ...
    $conn = new mysqli('localhost','root','','wordpress');
     ...
     $stmt=("UPDATE address SET pnumber = '$_POST[pnumber]',landmark = '$_POST[landmark]',hno = '$_POST[hno]',area = '$_POST[area]',city = '$_POST[city]',state = '$_POST[state]',pincode = '$_POST[pincode]' WHERE email='$_POST[email]'");
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <a href="AddressShowing1.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
