...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>All Products Removed Successfully</h1>"; ?>
            <a href="wishlist.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
<?php
 ...
 {
     $stmt =("DELETE FROM `wishlist` WHERE id LIKE '%$id%'");
      mysqli_query($conn,$stmt);
       ?>
          <html>
<link rel="stylesheet" type="text/css" href="css/style2.css">
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            <img src="image/right1.jpg" class="righticon">
            <?php echo"<h1>Product Removed Successfully</h1>"; ?>
            <a href="wishlist.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
