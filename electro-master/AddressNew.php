...
<style type="text/css">.input{ height: 40px;
  ...
  width: 95%;}</style>
    ...
    <header style="width:100%;">
        ...
        <div id="top-header">
            <div class="container">
  <ul class='header-links pull-left' style='margin-left: 10px;'><li><a href='cart.php' style='color:white; margin-left: -150px;'>&larr;Back</a></li>
...
<br>
    <form action="AddressconnectNew.php" method="post">
<div class="form">
    <?php   
 ...
 ?>
                            ...
                            <b>House No:</b>
                            <input class="input" style="margin-left: 2.8%;width: 30%;" type="number" name="hno" placeholder="Enter House No" required>
