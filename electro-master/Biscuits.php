...
<?php } ?>
 ...
 <?php
        ...
        $row3 = mysqli_fetch_array($re);
			...
			<h4 class='product-price'>₹".$row3['price']."<del class='product-old-price'>₹100</del></h4>
							...
							<div>
									 ...
									 <?php
                                        $stmt =("select * from product where id=3");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
		...
		";}; ?>
				...
				<?php
                                        $stmt =("select * from product where id=4");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
								<div class='product-widget'>
								<a href='product1.php?a1=1.1'>
									<div class='product-img'>
										<img src='".$row3['image']."' alt=''>
									</div>
									<div class='product-body'>
			...
			<h4 class='product-price'>₹".$row3['price']."<del class='product-old-price'>₹35 </del></h4>
								...
								";}; ?>
									...
									<?php
                                        $stmt =("select * from product where id=5");
        $re= mysqli_query($conn,$stmt);
        $row3 = mysqli_fetch_array($re);
                if(!$row3)
                {}elseif($re){ echo "
								<div class='product-widget'>
								<a href='product4.php?a1=4.1'>
									<div class='product-img'>
										<img src='".$row3['image']."' alt=''>
									</div>
									<div class='product-body'>
