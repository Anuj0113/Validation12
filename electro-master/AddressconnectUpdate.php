  ...
  width: 95%;}</style>
    ...
    <header style="width:100%;">
        ...
        <div id="top-header">
            ...
            <ul class='header-links pull-left' style='margin-left: 10px;'><li><a href='AddressUpdate.php' style='color:white; margin-left: -150px;'>&larr;Back</a></li>
    ...
    $conn = new mysqli('localhost','root','','wordpress');
     ...
     $stmt=("UPDATE address SET email = '$_POST[email]',pnumber = '$_POST[pnumber]',landmark = '$_POST[landmark]',hno = '$_POST[hno]',area = '$_POST[area]',city = '$_POST[city]',state = '$_POST[state]',home = '$_POST[home]',pincode = '$_POST[pincode]' WHERE email = '$_POST[email]'");
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>Address Edited Successfully</h1>"; ?>
            <a href="AddressShowing.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
