...
<style type="text/css">.input{ height: 40px;
  ...
  width: 95%;}</style>
    ...
    <header style="width:100%;">
        ...
        <div id="top-header">
            <div class="container">
            <ul class='header-links pull-left' style='margin-left: 10px;'><li><a href='AddressNew1.php' style='color:white; margin-left: -150px;'>&larr;Back</a></li>
...
$s="select * from address where email='$email1'";
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>Address Already Taken</h1>"; ?>
