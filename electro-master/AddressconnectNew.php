...
<body>
    ...
    <header>
        ...
        <div id="top-header">
            <div class="container">
            <ul class='header-links pull-left' style='margin-left: 10px;'>
                <li><a href='AddressNew.php' style='color:white; margin-left: -150px;'>&larr;Back</a></li>
    ...
    $email = $_POST['email'];
     ...
     $stmt1 =("select * from customer where email='$email'");
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>Home Or Work Address Already Taken</h1>"; ?>
            <a href="AddressNew.php"><button class="signup-btn" type="submit" value="Ok">Ok</button></a>
        </div>
    </body>
</html>
   ...
   <?php
        ...
        values('$email','$pnumber','$hno','$landmark','$area','$city','$state','$home','$pincode')");
...
<title>Product Validation</title>
    ...
    <body>
        <div class="sign-up-form">
            ...
            <?php echo"<h1>Address Added Successfully</h1>"; ?>
